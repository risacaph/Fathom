...
using Fathom.Server.ManualMigrations.v0._7._11;
using Fathom.Server.ManualMigrations.v0._7._14;
using Fathom.Server.ManualMigrations.v0._7._9;
using Fathom.Server.ManualMigrations.v0._8._0;
using Fathom.Server.ManualMigrations.v0._8._1;
using Fathom.Server.ManualMigrations.v0._8._2;
using Fathom.Server.ManualMigrations.v0._8._4;
using Fathom.Server.ManualMigrations.v0._8._5;
using Fathom.Server.ManualMigrations.v0._8._6;
using Fathom.Server.ManualMigrations.v0._8._7;
using Fathom.Server.ManualMigrations.v0._8._8;
using Fathom.Server.ManualMigrations.v0._8._9;
using Fathom.Server.ManualMigrations.v0._9._0;
using Fathom.Server.ManualMigrations.v0._9._1;
using Fathom.Server.Middleware;
using Fathom.Server.Swagger;
...
using Serilog;
using TaskScheduler = Fathom.Services.TaskScheduler;
...
public class Startup
{
    ...
    private static string GetLocalIpAddress()
    {
        ...
        throw new FathomException("No network adapters with an IPv4 address in the system!");
    }
