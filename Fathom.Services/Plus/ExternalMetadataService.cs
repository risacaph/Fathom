...
using Fathom.Models.DTOs.KavitaPlus.ExternalMetadata;
using Fathom.Models.DTOs.KavitaPlus.ExternalMetadata.Covers;
using Fathom.Models.DTOs.KavitaPlus.Metadata;
using Fathom.Models.DTOs.Metadata.Matching;
using Fathom.Models.DTOs.Person;
using Fathom.Models.DTOs.Recommendation;
...
public class ExternalMetadataService : IExternalMetadataService
{
    ...
    public async Task<ExternalSeriesDetailDto?> GetExternalSeriesDetail(int? aniListId, long? malId, int? seriesId, CancellationToken ct = default)
    {
        ...
        {
            throw new FathomException("Unable to find valid information from url for External Load");
        }
        ...
        bool fromMatchFlow = false, MetadataFetchTrigger trigger = MetadataFetchTrigger.OnDemand, CancellationToken ct = default)
    {
        ...
        catch (FlurlHttpException ex)
        {
            ...
            {
                throw new FathomException("Too many requests, slow down");
            }
        }
        catch (Exception ex)
        {
    ...
    public async Task<IList<ExternalCoverResponseDto>> GetExternalCovers(int seriesId, int? volumeId = null, int? chapterId = null, CancellationToken ct = default)
    {
        ...
        if (series == null) throw new FathomException("Series not found");
        ...
        if (volumeId.HasValue)
        {
            ...
            if (volume == null) throw new FathomException("Volume not found");
        ...
        if (chapterId.HasValue)
        {
            ...
            if (chapter == null) throw new FathomException("Chapter not found");
