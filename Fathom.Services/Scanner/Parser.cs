...
namespace Fathom.Services.Scanner;
...
public static partial class Parser
{
    ...
    public static string ParseSeries(string filename, LibraryType type)
    {
        return type switch
        {
            ...
            LibraryType.Regulations => ParseMangaSeries(filename),
            LibraryType.Research => ParseMangaSeries(filename),
    ...
    public static string ParseVolume(string filename, LibraryType type)
    {
        return type switch
        {
            ...
            LibraryType.Regulations => ParseMangaVolume(filename),
            LibraryType.Research => ParseMangaVolume(filename),
    ...
    public static string ParseChapter(string filename, LibraryType type)
    {
        return type switch
        {
            ...
            LibraryType.Regulations => ParseMangaChapter(filename),
            LibraryType.Research => ParseMangaChapter(filename),
