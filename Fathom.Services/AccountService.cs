    ...
    : IAccountService
{
        ...
        CancellationToken ct = default)
    {
        ...
        if (user.Id == defaultAdminUser.Id)
        {
            ...
            {
                throw new FathomException(await localizationService.TranslateAsync(actingUserId, "cannot-change-identity-provider-original-user"));
            }
        ...
        {
            throw new FathomException(await localizationService.TranslateAsync(actingUserId, "oidc-managed"));
        }
