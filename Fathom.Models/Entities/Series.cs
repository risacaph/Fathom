...
public class Series : IEntityDate, IHasReadTimeEstimate, IHasCoverImage, IHasMetadataIds
{
    ...
    /// <summary>
    /// Used internally for name matching. <see cref="Fathom.Services.Tasks.Scanner.Parser.Parser.Normalize"/>
    /// </summary>
    public required string NormalizedName { get; set; }
    /// <summary>
    /// Used internally for localized name matching. <see cref="Fathom.Services.Tasks.Scanner.Parser.Parser.Normalize"/>
    /// </summary>
